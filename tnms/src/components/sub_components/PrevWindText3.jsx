        ...
        <>
            <div>
                ...
                <div className="w-[100%] h-[150px] border-[#cccccc] border-10">
                    <p className="text-center pt-13">강풍에 대한 특보 기준을 미리 알아두고 강풍특보나 응급상황 시 즉시 대처할 수 있도록 합니다.</p>
                </div>
            </div>
            ...
            <div>
                ...
                <p className="text-2xl mb-10 font-bold">강풍이란</p>
            ...
            <div>
                ...
                <p className="text-2xl mb-10 font-bold">강풍특보</p>
                ...
                <div className="w-[100%] border border-l-0 border-r-0 flex justify-around relative">
                    ...
                    <div className="text-center">
                        ...
                        <p className="pt-5 pb-5">	육상에서 풍속 14m/s(50.4km/h)이상<br />또는 순간풍속 20m/s(72km/h) 이상,<br />다만 산지는 풍속 17m/s(61.2km/h)이상<br />또는 순간풍속 25m/s(90km/h)이상이 예상될 때</p>
                    </div>

                    <div className="text-center">
                        <p className="pt-5 pb-5">경보</p>
                        <p className="pt-5 pb-5">육상에서 풍속 21m/s(75.6km/h) 이상<br />또는 순간풍속 26m/s(93.6km/h) 이상,<br />다만 산지는 풍속 24m/s(86.4km/h)이상<br />또는 순간풍속 30m/s(108km/h)이상이 예상될 때</p>
                    </div>
