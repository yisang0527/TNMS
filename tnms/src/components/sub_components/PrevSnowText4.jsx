            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 대설로 인한 피해 여부를 확인합니다.
                    <ul className=" ml-1.5">
                        ...
                        <li>- 파손된 시설물(주택, 상하수도, 축대, 도로 등)은 가까운 행정복지센터(주민센터)나 시·군·구청에 신고합니다.</li>
                        <li>- 파손된 사유시설을 보수 또는 복구할 때는 반드시 사진을 찍어 둡니다.</li>
                        <li>- 고립된 지역에 있을 경우 무리하게 운전하여 이동하지 말고, 119 또는 112 등에 신고하거나 주변에 도움을 요청합니다.</li>
                        <li>- 내 집 앞, 내 점포 앞 보행로 등에 쌓인 눈은 가족이나 이웃과 함께 치워 결빙으로 인한 미끄럼 사고를 예방합니다. 제설작업 시에는 지붕 올라가기 등</li>
                        <li>  무리하지 말고 안전을 충분히 확보한 후 실시합니다.</li>
                        <li>  ※ 근처의 제설함을 활용할 수 있으며, 가까운 제설함은 공공데이터포털 행정안전부 제설함 검색을 통해 확인할 수 있습니다.</li>
                    </ul>
                </li>
            </ul>
            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 대설로 인한 2차 피해를 방지합니다.
                    <ul className=" ml-1.5">
                        ...
                        <li>- 가스, 전기가 차단되었을 때, 한국가스안전공사(1544-4500)와 한국전기안전공사(1588-7500) 또는 전문가의 안전점검 후에 사용합니다.</li>
                        <li>- 대설로 가스가 누출될 수 있으므로 창문을 열어 충분히 환기하고, 성냥불이나 라이터는 환기 전까지 사용하지 않습니다.</li>
                        <li>- 붕괴 위험이 있는 시설물은 점검 후에 출입하도록 합니다.</li>
                    </ul>
                </li>
            </ul>
