    ...
    return (
        <>
            ...
            <div className="w-[100%] h-[150px] border-[#cccccc] border-10 bg-[#ffffff]">
                <p className="text-center pt-14 text-[18px]">TV, 라디오, 인터넷 등에서 미세먼지 예, 경보 상황을 수시로 확인하고, 황사 피해 예방을 위해 시설물을 점검합니다.</p>
            </div>
            ...
            <p className="text-[20px] mb-10 font-bold">황사발생 전 행동요령 (황사 위기경보 '관심' 단계 발령 시)</p>
