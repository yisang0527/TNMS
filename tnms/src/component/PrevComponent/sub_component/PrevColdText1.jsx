            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 한랭질환(저체온증, 동상 등)에 대한 증상 및 조치사항을 사전에 숙지하고, 가까운 병원 연락처 등을 가족ㆍ이웃과 함께 알아둡니다.
                    <ul className=" ml-1.5">
                        ...
                        <li>- 당뇨 환자, 만성 폐질환자 등은 반드시 독감 예방접종을 합니다.</li>
                    </ul>
                </li>
            </ul>
            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">＜ 일반 가정 ＞
                    <ul className=" ml-1.5">
                        ...
                        <li>∙ 동파 방지를 위해 계량기 등은 미리 보온 조치를 합니다.</li>
                        <li> - 수도 계량기, 수도관 등에 찬 공기가 스며들지 않도록 헌 옷 등을 활용하여 보온합니다.</li>
                        <li>∙ 오래된 주택은 변압기를 사전에 점검하여 과부하에 대비합니다.</li>
                        <li>∙ 외출할 때를 대비하여 내복, 목도리, 모자, 장갑 등을 준비합니다.</li>
                        <li>∙ 정전에 대비하여 손전등, 비상 식음료, 휴대용 라디오 등을 미리 준비합니다.</li>
                        <li>∙ 단수에 대비하여 생수를 준비하고, 생활용수는 욕조에 미리 받아 둡니다.</li>
                        <li>∙ 장애인, 어린이, 노약자 등은 사전에 연락처를 확인하고 한파 대처 상황을 꼼꼼하게 챙깁니다.</li>
                        <li>∙ 가정 내 어린이와 노약자가 있는 경우 체온과 실내 온도를 자주 확인하여 충분히 따뜻하게 유지합니다.</li>
                        <li> - 만 1세 이하의 영유아는 절대 차가운 방에서 재우면 안됩니다.</li>
                        <li> - 집에 65세 이상의 어르신이 있는 경우 자주 볼 수 있는 실내 장소에 읽기 쉬운 온도계를 놓아둡니다.</li>
                        <li> ※ 노인들은 온도 변화를 느끼는 능력이 떨어지며, 낮은 신체대사와 활동으로 한파에 취약합니다.</li>
                    </ul>
                </li>
            </ul>
            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">＜ 차량 이용자 ＞
                    <ul className=" ml-1.5">
                        ...
                        <li>∙ 자동차 월동용품을 미리 준비해두고 자동차 상태를 수시로 점검합니다.</li>
                        <li> - 주요 월동용품으로는 스노체인(스프레이 체인), 모래주머니, 염화칼슘, 삽, 부동액, 축전지, 각종 윤활유 등이 있습니다.</li>
                        <li>∙ 창문을 닫고 히터를 오래 켜면 뇌에 전달되는 산소량이 떨어져 졸음을 유발할 수 있습니다. 졸음운전으로 인한 교통사고 예방을 위해 최소 30분에 1회 이상 창문을 열어 환기를 실시합니다.</li>
                    </ul>
                </li>
            </ul>
