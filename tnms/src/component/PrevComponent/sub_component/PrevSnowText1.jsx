export default function PrevSnowText1() {
    return (
        <>
            ...
            <div className="w-[100%] h-[150px] border-[#cccccc] border-10 bg-[#ffffff]">
                <p className="text-center pt-10 text-[18px]">대설은 짧은 시간에 급격히 눈이 쌓이게 되므로 교통 정체·고립, 쌓인 눈의 무게로 인한 시설물 붕괴·전도 등 다양한 피해가 발생될 수 있습니다.<br />사전에 다음과 같이 가족이나 이웃과 함께 준비합니다.</p>
            </div>
            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 재난 정보를 수신할 수 있도록 준비하고. 거주 지역의 재해위험 요인을 미리 확인합니다.
                    <ul className=" ml-1.5">
                        <li>- 재난정보는 TV, 라디오, 인터넷, 스마트폰 안전디딤돌 앱에서 수신합니다.</li>
                        <li> ※ 스마트폰 안전디딤돌 앱 설치를 통해 대설, 풍랑 등 기상특보나 눈사태, 시설물 붕괴 등 재난예ㆍ경보를 수신할 수 있습니다.</li>
                        <li>- 거주지역의 재해위험 요인(눈사태, 붕괴위험시설물 등)은 과거 피해 자료를 통해 확인합니다.</li>
                    </ul>
                </li>
            </ul>

            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 가족, 이웃과 함께 대피계획을 세웁니다.
                    <ul className=" ml-1.5">
                        <li>- 지역 대피장소와 안전한 이동 방법, 대피요령을 미리 숙지하고 어린이 등 재해약자에게 알려 줍니다.</li>
                        <li> ※ 지역의 대피장소는 국민재난안전포털이나 지자체 홈페이지의 임시대피소, 이재민 임시주거시설 등에서 확인할 수 있습니다.</li>
            ...
            <ul className="text-[18px] font-normal text-[#333333]">
                <li className=" mb-10">• 재난 발생에 대비하여 비상용품을 미리 준비합니다.
                    <ul className=" ml-1.5">
                        <li>- 응급약품, 손전등, 식수, 비상식량, 라디오, 핸드폰 충전기, 휴대용 버너, 연료, 담요 등 비상용품을 미리 한 곳에 준비해 둡니다.</li>
                        <li>- 차량이 있는 경우에는 연료를 미리 채워 두고, 차량이 없을 경우 차량이 있는 가까운 이웃과 같이 이동할 수 있도록 미리 약속해 둡니다.</li>
                    </ul>
                </li>
            </ul>
